				...
				<div>
					...
					<table  align="right" style="width: 100%; font-family: Verdana, Geneva, Tahoma, sans-serif; font-size: small;" bgcolor="#CCCCFF">
						...
						<tr>
							...
							<td><input readonly="true" type="text" maxlength="51" size="5" tabindex="1" name="txtNomeFantasia"
						value="<jsp:getProperty name='selecionarClienteJuridico' property='nomeFantasia' />"></td>
							...
							<td><input readonly="true"  type="text" maxlength="51" size="5" tabindex="1" name="txtEmail"
						...
						<tr>
							...
							<td><input readonly="true"  type="text" maxlength="51" size="50" tabindex="1" name="txtRazaoSocial"
						value="<jsp:getProperty name='selecionarClienteJuridico' property='razaosocial' />"></td>
							...
							<td><input readonly="true"  type="text" maxlength="51" size="5" tabindex="1" name="txtTelefone"
						...
						<tr>
							...
							<td><input readonly="true"  type="text" maxlength="51" size="5" tabindex="1" name="txtCnpj"
						value="<jsp:getProperty name='selecionarClienteJuridico' property='cnpj' />"></td>
							...
							<td><input readonly="true" type="text" maxlength="51" size="5" tabindex="1" name="txtEndereco"
						...
						<tr>
							...
							<input name="Alterar " type="submit" value="Voltar" style="width: 100px"></td>
							<td>&nbsp;</td>
						</tr>
					</table>
